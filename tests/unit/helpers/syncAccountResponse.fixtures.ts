...
import type { MpcMaterialActivationRef } from '../../../packages/shared-ts/src/utils/domainIds';
import {
...
export const MATERIAL_ACTIVATION: MpcMaterialActivationRef = buildMpcMaterialActivationRefFixture(
  'sync-account-yao',
