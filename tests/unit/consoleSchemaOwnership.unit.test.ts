...
const WALLET_CONSOLE_TABLES = [
  ...
  'console_step_up_challenges',
  'console_step_up_credentials',
  'key_exports',
  'policies',
  'policy_assignments',
  'policy_versions',
  ...
  'tenant_root_security_approval_requests',
  'tenant_root_security_approvals',
  'tenant_root_security_custody_challenges',
  'tenant_root_security_custody_staged_recipients',
  'tenant_root_security_custody_state',
  'tenant_root_security_operations',
  'tenant_root_security_recovery_generation',
...
test('fresh composed Wallet Console schema creates exactly core plus wallet tables', () => {
  ...
  expect(created.size).toBe(expected.length);
});
