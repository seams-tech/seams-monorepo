...
moved to the implementation journal retained in Git history; phase sections
...
The completed implementation journal is retained in Git history. This plan
carries statuses and open tasks.
...
notes remain in the implementation journal in Git history.
...
the implementation journal retained in Git history.
...
Phase 10. Notes: the implementation journal retained in Git history.
