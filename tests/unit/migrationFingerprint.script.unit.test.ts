...
test('Console applied baseline stays immutable and upgrades to the fresh schema', async () => {
  ...
  try {
    ...
    expect(migrationNames).toEqual([
      ...
      '0030_tenant_root_creation_grants.sql',
      '0031_tenant_root_security_operations.sql',
      '0032_tenant_root_step_up.sql',
      '0033_tenant_root_approval_requests.sql',
      '0034_console_step_up_credentials.sql',
      '0035_tenant_root_dispatch_uncertainty.sql',
      '0036_tenant_root_refresh_trigger.sql',
      '0037_tenant_root_security_restore.sql',
      '0038_tenant_root_security_custody.sql',
      '0039_tenant_root_restore_refresh_grants.sql',
      '0040_tenant_root_restore_identity.sql',
      '0041_refund_ledger_debits.sql',
      '0041_tenant_root_recipient_verifier.sql',
      '0042_tenant_root_recovery_generation.sql',
      '0043_tenant_root_cli_enrollment.sql',
      '0044_tenant_root_cli_restore_access.sql',
      '0045_tenant_root_backup_access.sql',
    ]);
