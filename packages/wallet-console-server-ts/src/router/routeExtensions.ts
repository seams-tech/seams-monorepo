...
import {
  DEFAULT_WALLET_CONSOLE_SIGNED_DELEGATE_ROUTE_V1 as DEFAULT_SIGNED_DELEGATE_ROUTE,
  DEFAULT_WALLET_CONSOLE_SPONSORED_EVM_CALL_ROUTE_V1 as DEFAULT_SPONSORED_EVM_CALL_ROUTE,
