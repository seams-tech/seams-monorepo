...
function fixtureRegistrationFacts(clientId: string): RouterAbEcdsaRegistrationRequestFactsV1 {
...
export function routerAbEcdsaRegistrationPendingFinalizationFixture(
  input: { readonly clientId?: string } = {},
): RouterAbEcdsaRegistrationPendingFinalizationFixture {
  const registrationFacts = fixtureRegistrationFacts(input.clientId ?? 'client-fixture');
