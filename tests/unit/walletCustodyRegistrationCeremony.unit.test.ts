...
import {
  ...
  computeWalletCustodyNearEd25519KeyManifestDigestB64u,
...
test('the NEAR custody manifest digest matches the Rust canonical encoding', async () => {
  await expect(
    computeWalletCustodyNearEd25519KeyManifestDigestB64u({
      walletId: 'wallet-1',
  ...
  ).resolves.toBe('EEFS54sZkjGaViW0WmHjANruU086Z6e7Jh-ScljlVos');
});
