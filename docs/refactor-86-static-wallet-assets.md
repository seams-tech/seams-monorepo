...
The completed implementation journal is retained in Git history. Track remaining
work in this plan.
...
- [x] Record every guard added by this phase in the
      [Source-guard ledger](./refactor-88B-clean-source-guards.md) ledger with intake
